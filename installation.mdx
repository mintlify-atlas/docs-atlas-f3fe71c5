...
This guide will help you set up CampusBite on your local machine for development purposes. The application consists of a React frontend, Node.js backend, and PostgreSQL database.
...
<Note>
  You can use a hosted PostgreSQL database like [Supabase](https://supabase.com/), [Neon](https://neon.tech/), or [Railway](https://railway.app/) instead of installing PostgreSQL locally.
</Note>
...
<Steps>
  ...
  <Step title="Set up the database">
    Create a new PostgreSQL database named `campusbite`:
    ...
    <Info>
      Database tables are automatically created on the first server start. You don't need to run any migration scripts.
    </Info>

    If using a hosted database, copy your connection string. It should look like:
