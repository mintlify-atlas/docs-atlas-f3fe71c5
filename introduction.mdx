...
<div className="min-h-screen dark:bg-[#0f1117] bg-white">
  ...
  <div className="mt-16 mb-16 max-w-5xl mx-auto px-6">
    ...
    <Steps>
      ...
      <Step title="Set up PostgreSQL database">
        Create a PostgreSQL database for CampusBite. The application will automatically create the required tables on first run.
  ...
  <div className="mt-16 mb-16 max-w-5xl mx-auto px-6">
    ...
    <CardGroup cols={3}>
      ...
      >
        React 18, Node.js, Express, PostgreSQL, Tailwind CSS v4
      </Card>
      <Card
  ...
  <div className="mt-16 mb-16 max-w-5xl mx-auto px-6">
    ...
    <CardGroup cols={2}>
      ...
      >
        Configure PostgreSQL with auto-schema creation
      </Card>
      <Card
